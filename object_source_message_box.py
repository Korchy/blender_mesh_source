...
class OBJECT_SOURCE_OT_messagebox(Operator):
    bl_idname = 'object_source.messagebox'
    bl_label = ''
...
def register():
    register_class(OBJECT_SOURCE_OT_messagebox)


def unregister():
    unregister_class(OBJECT_SOURCE_OT_messagebox)
